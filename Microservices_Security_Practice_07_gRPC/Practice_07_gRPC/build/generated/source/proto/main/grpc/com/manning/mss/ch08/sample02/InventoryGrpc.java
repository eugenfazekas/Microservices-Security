...
public final class InventoryGrpc {
  ...
  public static final String SERVICE_NAME = "sample02.Inventory";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.manning.mss.ch08.sample02.Order,
      com.manning.mss.ch08.sample02.UpdateReply> getUpdateInventoryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateInventory",
      requestType = com.manning.mss.ch08.sample02.Order.class,
      responseType = com.manning.mss.ch08.sample02.UpdateReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.manning.mss.ch08.sample02.Order,
      com.manning.mss.ch08.sample02.UpdateReply> getUpdateInventoryMethod() {
    io.grpc.MethodDescriptor<com.manning.mss.ch08.sample02.Order, com.manning.mss.ch08.sample02.UpdateReply> getUpdateInventoryMethod;
      ...
      synchronized (InventoryGrpc.class) {
        if ((getUpdateInventoryMethod = InventoryGrpc.getUpdateInventoryMethod) == null) {
          InventoryGrpc.getUpdateInventoryMethod = getUpdateInventoryMethod = 
              io.grpc.MethodDescriptor.<com.manning.mss.ch08.sample02.Order, com.manning.mss.ch08.sample02.UpdateReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "sample02.Inventory", "UpdateInventory"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.manning.mss.ch08.sample02.Order.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.manning.mss.ch08.sample02.UpdateReply.getDefaultInstance()))
  ...
  public static abstract class InventoryImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void updateInventory(com.manning.mss.ch08.sample02.Order request,
        io.grpc.stub.StreamObserver<com.manning.mss.ch08.sample02.UpdateReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.manning.mss.ch08.sample02.Order,
                com.manning.mss.ch08.sample02.UpdateReply>(
  ...
  public static final class InventoryBlockingStub extends io.grpc.stub.AbstractStub<InventoryBlockingStub> {
    ...
    /**
     */
    public com.manning.mss.ch08.sample02.UpdateReply updateInventory(com.manning.mss.ch08.sample02.Order request) {
  ...
  public static final class InventoryFutureStub extends io.grpc.stub.AbstractStub<InventoryFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.manning.mss.ch08.sample02.UpdateReply> updateInventory(
        com.manning.mss.ch08.sample02.Order request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPDATE_INVENTORY:
          serviceImpl.updateInventory((com.manning.mss.ch08.sample02.Order) request,
              (io.grpc.stub.StreamObserver<com.manning.mss.ch08.sample02.UpdateReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class InventoryBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.manning.mss.ch08.sample02.InventoryProto.getDescriptor();
    }
